...
- Use CSS to alter the style, formatting, or irregular heading hierarchy instead of altering the heading elements or creating new formatting.
...
- Don't use extra line breaks or other formatting to increase heading spacing.
