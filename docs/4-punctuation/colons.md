...
Include a colon at the end of a phrase or sentence that lists. The text preceding the colon must distinctly stand alone as a complete sentence.
...
Don't include a colon in text preceding code, code backticks (``` ` ```), or a `<code>` tag unless it is part of the code.
