...
[tip] **Recommended:** For best results, use a desktop that has a 64-bit operating system. [/tip]  
...
For more information, see [WordPress widgets](https://wordpress.org/support/article/wordpress-widgets/).
